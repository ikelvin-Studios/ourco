...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <a href="#upcomingReturns" class="btn btn-sm btn-primary shadow-sm"><i class="fas fa-upload fa-sm text-white-50"></i> <?=$dbReturns->rowCount()?> Incomplete Requests</a>
              ...
              ?>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                        ...
                        <input id="" name="invest_amount" type="number" class="form-control" placeholder="Min of 10 in OurCoin" required="true" />
                        <span class="input-group-addon">.00</span>
                  </div>
                </div>
                <small id="CurrencyValue" class="form-text text-muted mb-1">NB: 1 Ourcoin = $1.</small>
                ...
                <?php } else { ?>
                  ...
                  <div class="form-group text-lg">
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          <a id="" class="form-control btn btn-primary" href="../pages/funds">Withdraw Funds</a>
                        </div>
                      </div>
                    </div>
                    <h6 class="">
                      NB: <i class="fas fa-database fa-sm fa-fw"></i>1 (Ourcoin) = $1 (Dollar)
                    </h6>
                    ...
                    <div class="mb-2">
                      ...
                      <i class="fas fa-database fa-sm fa-fw"></i> <?= site::fp_retain($powerwallet['available']) ?>
                       = <?= $user_currency_symbol ?> <?= site::fp_retain($powerwallet['available']) ?>
                      </div>
                    </div>
                    ...
                    <div class="mb-2">
                      ...
                      <i class="fas fa-database fa-sm fa-fw"></i> <?= site::fp_retain($powerwallet['reserved']) ?>
                       = <?= $user_currency_symbol ?> <?= site::fp_retain($powerwallet['reserved']) ?>
                      </div>
                    </div>
                    ...
                    <div class="mb-2">
                      ...
                      <i class="fas fa-database fa-sm fa-fw"></i> <?= site::fp_retain($powerwallet['bonus']) ?>
                       = <?= $user_currency_symbol ?> <?= site::fp_retain($powerwallet['bonus']) ?>
                      </div>
                    </div>
...
<?php
      ...
      <?php } else {  ?>
        ...
        <div class="progress mb-4">
          <div class="progress-bar progress-bar-striped active" role="progressbar" style="width: <?= $growth ?>%" aria-valuenow="<?= $growth ?>" aria-valuemin="0" aria-valuemax="100"><?=$growth?>% <?= $diff->format("%R%a days") ?> left</div>
        </div>
        <?php }
      }
    } else {
