          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="#">
                  ...
                  <div>
                    <div class="small text-gray-500"> On January 3, 2020</div>
                    <span class="font-weight-bold">Our Next Phase Begins!</span>
                  </div>
                </a>
                <!-- <a class="dropdown-item d-flex align-items-center" href="#">
                  <div class="mr-3">
                ...
                <!-- <a class="dropdown-item text-center small text-gray-500" href="#">You have no Alerts</a> -->
                <a class="dropdown-item text-center small text-gray-500" href="#">Our Next Phase Begins on On January 3, 2020. Thanks for your trust and support while the update was rolling. We are so excited you are here, We have some cards for you below</a>
              </div>
            </li>
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - wallet -->
                <span class="badge badge-danger badge-counter"><i class="fas fa-database fa-sm fa-fw"></i><?= site::fp_retain($powerwallet['available']+0) ?></span>
              </a>
              <!-- Dropdown - wallet -->
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                <h6 class="dropdown-header">
                ...
                <a class="dropdown-item d-flex align-items-center text-center"  href="#" data-toggle="modal" data-target="#CurrencyModal">
                  <div class="text-center center ml-4">
                  <i class="fas fa-sign-in-alt ml-4 mr-3"></i> <strong> Change Currency </strong>
                  </div>
                </a>
                ...
                <!-- <a class="dropdown-item text-center small text-gray-500" href="#">Read More Messages</a> -->
                <a class="dropdown-item text-center small text-gray-500" href="#">Wallet Not Ready Yet</a>
              </div>
            </li>
